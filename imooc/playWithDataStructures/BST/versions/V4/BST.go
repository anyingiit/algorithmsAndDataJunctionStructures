...
func (b *BST) RemoveMin() (deletedElement int, err error) {
	if b.IsEmpty() {
		return 0, fmt.Errorf("cant remove min: BST is empty")
	}
	...
	if deletedNode == nil {
		return 0, fmt.Errorf("cannot remove min: other error")
	}
	b.size--
	return deletedNode.e, nil
}
func (b *BST) RemoveMax() (deletedElement int, err error) {
	if b.IsEmpty() {
		return 0, fmt.Errorf("cant remove min: BST is empty")
	}
	...
	if deletedNode == nil {
		return 0, fmt.Errorf("cannot remove max: other error")
	}
	b.size--
	return deletedNode.e, nil
}
